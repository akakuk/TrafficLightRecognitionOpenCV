...
cv2.imwrite("imgThreshold.png", img_globalThreshold)
cv2.waitKey()
cv2.destroyAllWindows()

circles = cv2.HoughCircles(img_globalThreshold , cv2.HOUGH_GRADIENT, 1, 100, param1=255, param2=8, minRadius=1, maxRadius=20)
#print(circles)
